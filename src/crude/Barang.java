...
public class Barang {
    ...
    // insert data barang
    public void insert(connection m, Integer idBarang, String namaBarang, Integer hargaBarang, Integer stokBarang){
        // koneksi mysql
        Connection koneksi = m.conn;
        
        // query mysql
        String sql = "INSERT INTO barang (id_barang, nama_barang, harga_barang, stok_barang) VALUES (?, ?, ?, ?)";
